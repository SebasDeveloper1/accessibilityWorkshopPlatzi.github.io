...
function clickLeft() {
  ...
  switch (newValue) {
    case -270:
      ...
      document.querySelector(".project5-container").removeAttribute("aria-hidden", true);
    ...
    case 0:
      ...
      document.querySelector(".project4-container").removeAttribute("aria-hidden", true);
...
/*Esta funcion valida el formulario antes de mostrar la notificacion*/
